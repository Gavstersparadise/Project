...
class ProductController extends CI_Controller {
	...
	function error() {
		...
		if ($this -> form_validation -> run() == FALSE) {
			...
			$data = array('product_name' => $this -> input -> post('product_name'), 'product_code' => $this -> input -> post('product_code'), 'product_description' => $this -> input -> post('product_description'), 'category_id' => $this -> input -> post('category_id'), 'product_price' => $this -> input -> post('product_price'), );
