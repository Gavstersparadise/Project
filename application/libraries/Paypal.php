...
class Paypal {
	...
	function __initialize($props = array())
	{
		...
		$config["return"] 			= 'http://localhost:8666/Project/index.php/site/members'; //The URL 
		$config["cancel_return"]	= ''; //Specify a URL on your websto which PayPal redirects buyersÃ¢â‚¬â„¢ browser after they complete their payments.ite that displays a Ã¢â‚¬Å“Payment CanceledÃ¢â‚¬Â page.
		$config["notify_url"] 		= 'http://localhost:8666/Project/site/notify_payment';  //The URL to which PayPal posts information about the payment (IPN)
